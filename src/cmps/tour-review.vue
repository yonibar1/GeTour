                ...
                <div class="review">
                    <div class="mini-user">
                        ...
                        <div class="mini-user-details">
                            <router-link
                                :to="`/user-profile/${review.byUser._id}`"
                            >
            ...
            <form @submit.prevent="addReview()">
                ...
                <div class="block">
                    <div class="rate-block">
                        ...
                        <el-rate
                            allow-half
                            v-model.number="reviewToEdit.rate"
                        ></el-rate>
                    </div>
...
export default {
    ...
    methods: {
        async addReview() {
            ...
            const msg = {
                title: `Review added by - ${this.loggedInUser.fullname}`,
                message: `${this.loggedInUser.fullname} Just Added a Review On ${this.tour.title}`,
            };
